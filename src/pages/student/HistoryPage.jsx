              ...
              <CardContent className="flex items-center justify-between p-4">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    {formatDate(attempt.completedAt)} &middot; {formatTime(attempt.timeTaken)}
                  </p>
                </div>
                <div className="flex items-center gap-3">
                  <Badge variant={attempt.percentage >= 70 ? "success" : attempt.percentage >= 40 ? "secondary" : "destructive"}>
